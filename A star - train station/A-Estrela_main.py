"""Guilherme Moreira de Carvalho 14/04/2023 - Para Laboratório de Inteligência Artificial, 2023/1"""
"""1ª Avaliação de Laboratório de IA - Busca A*: Metrô de Paris"""
...
if __name__ == "__main__":
	...
	for linha in f:
		valores = linha.split(";")
		heuristica[valores[0]] = float(valores[1])
	f.close()
	...
	[caminho, custo] = busca("E6", "E13", heuristica, grafo)
